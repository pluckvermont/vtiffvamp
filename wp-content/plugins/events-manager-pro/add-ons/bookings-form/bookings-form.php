...
class EM_Booking_Form {
	...
	public static function init(){	
		...
		self::$form_template = array (
			'name' => array ( 'label' => __('Name','em-pro'), 'type' => 'name', 'fieldid'=>'user_name', 'required'=>1 ),
			'user_email' => array ( 'label' => __('Email','dbem'), 'type' => 'user_email', 'fieldid'=>'user_email', 'required'=>1 ),
	    	'dbem_address' => array ( 'label' => __('Address','em-pro'), 'type' => 'dbem_address', 'fieldid'=>'dbem_address', 'required'=>1 ),
	    	'dbem_city' => array ( 'label' => __('City','em-pro'), 'type' => 'dbem_city', 'fieldid'=>'dbem_city', 'required'=>1 ),
	    	'dbem_state' => array ( 'label' => __('State/County','em-pro'), 'type' => 'dbem_state', 'fieldid'=>'dbem_state', 'required'=>1 ),
	    	'dbem_zip' => array ( 'label' => __('Zip/Post Code','em-pro'), 'type' => 'dbem_zip', 'fieldid'=>'dbem_zip', 'required'=>1 ),
	    	'dbem_country' => array ( 'label' => __('Country','em-pro'), 'type' => 'dbem_country', 'fieldid'=>'dbem_country', 'required'=>1 ),
	    	'dbem_phone' => array ( 'label' => __('Phone','em-pro'), 'type' => 'dbem_phone', 'fieldid'=>'dbem_phone' ),
	    	'dbem_fax' => array ( 'label' => __('Fax','em-pro'), 'type' => 'dbem_fax', 'fieldid'=>'dbem_fax' ),
		  	'textarea' => array ( 'label' => __('Comment','em-pro'), 'type' => 'textarea', 'fieldid'=>'booking_comment' ),
		);
	}
