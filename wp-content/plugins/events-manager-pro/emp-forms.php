			...
			<div class="inside">
				<table class='form-table'>
					<?php 
						...
						em_options_radio_binary ( __( 'Show name profile fields?', 'em-pro' ), 'dbem_emp_booking_form_reg_show_name', sprintf(__( 'If fields are editable users will be able to change their %s whilst making a booking.', 'em-pro' ), __('name','em-pro')) );
						em_options_radio_binary ( __( 'Show email profile fields?', 'em-pro' ), 'dbem_emp_booking_form_reg_show_email', sprintf(__( 'If fields are editable users will be able to change their %s whilst making a booking.', 'em-pro' ), __('email','em-pro')) );
		...
		if( !empty($field) ){
			...
			if( is_user_logged_in() && !EM_Bookings::$force_registration ){
				...
				if( !get_option('dbem_emp_booking_form_reg_show_name') ){
					$hidden_fields = array_merge($hidden_fields, array('first_name','last_name', 'user_email', 'name'));
				}
