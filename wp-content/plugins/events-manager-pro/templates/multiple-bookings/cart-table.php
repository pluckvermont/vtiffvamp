	...
	<table>
		<tbody class="em-cart-summary">
			...
			<tr class="em-cart-title">
				<th class="em-cart-title-event"><?php esc_html_e('Event','em-pro'); ?></th>
				<th class="em-cart-title-spaces"><?php esc_html_e('Spaces','em-pro'); ?></th>
				<th class="em-cart-title-price"><?php esc_html_e('Price','dbem'); ?></th>
			</tr>
			<?php foreach($EM_Multiple_Booking->get_bookings() as $EM_Booking): /* @var $EM_Booking EM_Booking */ ?>
				<tr class="em-cart-table-event-summary" id="em-cart-table-event-summary-<?php echo $EM_Booking->get_event()->event_id; ?>">
					<td>
						...
						<?php esc_html_e('When','em-pro'); ?> : #_EVENTDATES @ #_EVENTTIMES<br />
						<?php esc_html_e('Where','em-pro'); ?> : #_LOCATIONFULLLINE
